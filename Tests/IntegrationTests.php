...
class IntegrationTests extends PHPUnit_Framework_TestCase
{
    ...
    public function doResetDb()
    {
        ...
        $resetElements = [ 'Dropping Triggers: SearchController'
