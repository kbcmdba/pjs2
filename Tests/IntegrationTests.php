...
class IntegrationTests extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function checkJobStats($overdue = "0", $dueToday = "0", $due7day = "0", $highUrgency = "0", $mediumUrgency = "0", $lowUrgency = "0", $searches = "0")
    {
    ...
    public function doTestApplicationStatuses()
    {
        ...
        $this->assertEquals(true, $driver->findElement(WebDriverBy::id('isActive12'))
            ->isSelected());
    ...
    public function checkC1R($id, $prefix1, $prefix2, $company, $address1, $city, $state, $zip, $agencyId, $address2, $phone, $url, $lastContacted)
    {
        if ($this->_testMode < 1) {
            return;
        }
    ...
    public function doTestCompanies()
    {
        ...
        $this->checkC1HR();
        $this->checkC1R(1, "/tr[@id='ux1-1']", "/tr[@id='ux1-2']", 'Company 1', '1 Any Street', 'City 1', 'S1', '11111-1111', 'None', '', '111-111-1111', 'http://testme1.com/', '2017-01-01 00:00:00');
        ...
        $this->checkC1R(1, "/tr[@id='ux1-1']", "/tr[@id='ux1-2']", 'Company 1', '1 Any Street', 'City 1', 'S1', '11111-1111', 'None', '', '111-111-1111', 'http://testme1.com/', '2017-01-01 00:00:00');
        $this->checkC1HR();
        $this->checkC1R(1, "/tr[@id='ux2-1']", "/tr[@id='ux2-2']", 'Company 2', 'c/o Me', 'City 2', 'S2', '22222-2222', 'Company 1', '2 Any Street', '222-222-2222', 'http://testme2.com/', '');
        ...
        $this->checkC1HR();
        $this->checkC1R(1, "/tr[@id='ux1-1']", "/tr[@id='ux1-2']", 'Company 1', '1 Any Street', 'City 1', 'S1', '11111-1111', 'None', '', '111-111-1111', 'http://testme1.com/', '2017-01-01 00:00:00');
        $this->checkC1R(1, "/tr[@id='ux2-1']", "/tr[@id='ux2-2']", 'Company 2b', 'c/o Me 2', 'City 2b', '22', '22222-222B', 'None', '2B Any Street', '222-222-222B', 'http://www.testme2.com/', '');
        $driver->findElement(WebDriverBy::id('UpdateButton2'))->click();
        $this->doWaitFor(WebDriverBy::id('SaveButton2'));
        $this->doWaitFor(WebDriverBy::id('CancelButton2'));
        $this->checkIdText('SaveButton2', 'Save');
        ...
        $this->checkC1HR();
        $this->checkC1R(1, "/tr[@id='ux1-1']", "/tr[@id='ux1-2']", 'Company 1', '1 Any Street', 'City 1', 'S1', '11111-1111', 'None', '', '111-111-1111', 'http://testme1.com/', '2017-01-01 00:00:00');
        $this->checkC1R(1, "/tr[@id='ux2-1']", "/tr[@id='ux2-2']", 'Company 2c', 'c/o Me 3', 'City 2c', '32', '22222-222c', 'Company 1', '2c Any Street', '222-222-222c', 'http://www3.testme2.com/', '');
        $driver->findElement(WebDriverBy::id('DeleteButton1'))->click();
        $this->doWaitFor(WebDriverBy::id('DeleteButton1'));
        $this->doWaitFor(WebDriverBy::id('CancelButton1'));
        $this->checkIdText('DeleteButton1', 'Confirm Delete');
    ...
    public function checkC2R($id, $prefix, $contactCompany, $contactName, $contactEmail, $contactPhone, $contactAlternatePhone)
    {
        if ($this->_testMode < 1) {
            return;
        }
    ...
    public function checkJR($id, $prefix, $primaryContact, $company, $applicationStatus, $lastStatusChange, $urgency, $nextActionDue, $nextAction, $positionTitle, $location, $url)
    {
        if ($this->_testMode < 1) {
            return;
        }
    ...
    public function checkSeR($id, $prefix, $engineName, $searchName, $url, $rssFeedUrl, $rssLastChecked)
    {
        if ($this->_testMode < 0) {
            return;
        }
    ...
    public function doTestSearches()
    {
        ...
        $this->doWaitFor(WebDriverBy::id('UpdateButton1'));
        $this->doWaitFor(WebDriverBy::id('DeleteButton1'));
        $this->checkSeR(1, '', 'LinkedIn', 'LinkedIn General', 'http://www.linkedin.com/', 'http://www.linkedin.com', '2017-01-01');
        $driver->findElement(WebDriverBy::id('AddButton'))->click();
        $this->doWaitFor(WebDriverBy::id('SaveButtonix2'));
        $this->doWaitFor(WebDriverBy::id('CancelButtonix2'));
        ...
        $this->doWaitFor(WebDriverBy::id('UpdateButton2'));
        $this->doWaitFor(WebDriverBy::id('DeleteButton2'));
        $this->checkSeR(2, '', 'Dice', 'Dice General', 'http://www.dice.com/', 'http://www.dice.com', '2017-02-02');
        $this->checkSeR(1, '/tr[3]', 'LinkedIn', 'LinkedIn General', 'http://www.linkedin.com/', 'http://www.linkedin.com', '2017-01-01');
        $driver->findElement(WebDriverBy::id('AddButton'))->click();
        $this->doWaitFor(WebDriverBy::id('SaveButtonix3'));
        $this->doWaitFor(WebDriverBy::id('CancelButtonix3'));
        $driver->findElement(WebDriverBy::id('CancelButtonix3'))->click();
        ...
        $this->doWaitFor(WebDriverBy::id('DeleteButton1'));
        $this->checkSeHR();
        $this->checkSeR(2, '', 'Dicey', 'Dicey General', 'http://www.dicey.com/', 'http://www.dicey.com', '2017-02-03');
        $this->checkSeR(1, '/tr[2]', 'LinkedIn', 'LinkedIn General', 'http://www.linkedin.com/', 'http://www.linkedin.com', '2017-01-01');
        $driver->findElement(WebDriverBy::id('DeleteButton2'))->click();
        $this->checkHeaderLoads();
        $this->doWaitFor(WebDriverBy::id('DeleteButton2'));
        $this->doWaitFor(WebDriverBy::id('CancelButton2'));
