...
try {
    ...
    $row = $applicationStatusRowView->displayApplicationStatusRow($applicationStatusModel, 'list', 'Add Application Status record failed. ' . $e->getMessage());
}

$result = [
    'result' => $result,
    'row' => $row,
    'newId' => $applicationStatusId
];
